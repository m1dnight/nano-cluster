...
%% Vendored from atomvm_lib (src/gen_tcp_server.erl @ master); httpd depends on
%% it. Only change from upstream: the trace.hrl include_lib is a plain -include
%% of the copy next to this file. See src/httpd.erl for the full note.
